...
docker commit --change='CMD ["--db", "/app/data", "--accounts", "16", "--wallet.seed", "20070213", "--port", "8555", "--fork", "${MAINNET_FORK_URL}", "-v"]' ajna-testnet ghcr.io/ajna-finance/ajna-testnet:${tag} || exit 3
