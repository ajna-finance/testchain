...
npx hardhat node --port 8558 >"hardhat.log" 2>&1 &
hardhat_pid=$!
export ETH_RPC_URL=http://127.0.0.1:8558
export DEPLOY_ADDRESS=0xBcd4042DE499D14e55001CcbB24a551F3b954096
export DEPLOY_RAWKEY=0xf214f2b2cd398c806f84e317254e0f0b801d0643303237d97a22a48e01628897
sleep 2
